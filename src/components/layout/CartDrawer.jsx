            ...
            <div className="cart-item-content">
              <div className="cart-item-head">
                <div className="summary-item-copy">
                  ...
                  <p className="cart-item-unit-price">{formatCurrency(Number(item.price || 0))} each</p>
                </div>
                <strong className="cart-item-price">{formatCurrency(Number(item.price || 0) * Number(item.quantity || 1))}</strong>
              </div>
