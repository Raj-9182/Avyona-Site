...
export default function Home({ context }) {
  ...
  const catalogProducts = activeCategory === "all"
    ? featuredProducts
    : featuredProducts.filter((product) => product.collectionSlug === activeCategory);
        ...
        <div className="category-grid">
          {mainCategories.map((category) => (
            <Link key={category.slug} className="category-card category-card-link" to={`/category/${category.slug}`}>
              <div className="category-art"><img src={category.bannerImageUrl} alt={category.name} loading="lazy" decoding="async" /></div>
